...
const INGEST_PROMPT = [
  ...
  '      {"id":"<unique>","page":"wiki/<file>.md","title":"<short topic>","claims":[{"text":"<claim A>","author":"기존 문서"},{"text":"<claim B>","author":"<capture author>","capturedAt":"YYYY-MM-DD","sourcePath":"inbox/<file>.md"}],"openedAt":"<ISO datetime>","votes":{}}',
  '      ("page" MUST be the full path like "wiki/Foo.md"; "claims" MUST be an array named claims.)',
...
const LINT_PROMPT = [
  ...
  '- CONFLICTS: record contradictions with the exact fenced <!-- llmwiki:conflict --> page block AND a .llmwiki/conflicts.json array entry {"id","page":"wiki/<file>.md","title","claims":[{"text","author"},...],"openedAt","votes":{}} — do NOT resolve or reword them.',
